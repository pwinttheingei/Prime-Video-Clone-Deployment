...
pipeline {
    ...
    stages {
        ...
        stage ("Git checkout") {
            steps {
                git branch: 'main', url: 'https://github.com/pwinttheingei/Prime-Video-Clone-Deployment.git'
            }
        }
        ...
        stage ("Deploy to Conatiner") {
            steps {
                sh 'docker run -d --name amazon-prime -p 3000:3000 1632000/amazon-prime:latest'
            }
        }
    }
    post {
